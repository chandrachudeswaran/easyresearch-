		...
		<div class="col-md-4 col-md-offset-7">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<sf:form action="${pageContext.request.contextPath}/doRegistration"
						name='f' method="post" class="form-horizontal" role="form" commandName="users" id="details">
						<div class="form-group">
							<label for="username" class="col-sm-3 control-label">Username</label>
							<div class="col-sm-9">
								<sf:input type="text" name="username" class="form-control"
									id="inputEmail3" placeholder="Username" path="username" /><sf:errors path="username" cssClass="formerror"></sf:errors>
							</div>
						</div>
						<div class="form-group">
