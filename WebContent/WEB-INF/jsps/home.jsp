...
<head>
    ...
    <meta name="author" content="chandrachudeswaran">

    <title>Easy Research - Home</title>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="site-heading">
                        <h1>Easy Research</h1>
                        <hr class="small">
                        <span class="subheading">Conference Management System</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <ul class="list-inline text-center">
                        ...
                        <li>
                            <a href="https://www.facebook.com/chandrachudeswaran.sankar">
                                <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x"></i>
                        ...
                        <li>
                            <a href="https://github.com/chandrachudeswaran">
                                <span class="fa-stack fa-lg">
                                    <i class="fa fa-circle fa-stack-2x"></i>
                    ...
                    <p class="copyright text-muted">Copyright &copy; Easy Research 2015</p>
                </div>
            </div>
        </div>
    </footer>
